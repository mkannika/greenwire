...
<head>
	...
	<link rel="stylesheet" href="assets/css/dispensary_updates.css">
</head>
<body>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col col-content">
						<h1>Dispensary updates</h1>
						<p>ติดตามร้านขายยาเพื่อดูการปรับปรุงที่นี่ หากคุณติดตามร้านขายยาแล้ว โปรดคอยติดตาม - การอัปเดตใหม่ๆ จะถูกโพสต์ที่นี่!</p>
						<a href="#" class="d-flex align-items-center justify-content-center">see dispensaries near you</a>
					</div>
				</div>
			</div>
		</section>
