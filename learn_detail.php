...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/learn_detail.css">
        ...
        <div class="container">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">How to smoke weed</li>
                </ol>
            </nav>
            ...
            <section class="main">
                <div class="row mt-5">
                    <!-- Sidebar -->
                    <?php include 'elements/sidebar_tags.php'; ?>

                    <!-- Content -->
                    <div class="col-md-9 learn-content">
                        <p><img src="./assets/images/learn/learn_large.jpg" alt="Mock up"></p>
                        <div class="d-md-flex justify-content-between border-bottom py-4 my-4">
                            <div class="title">
                                <h2>How to smoke weed</h2>
                                <div class="card-tags">
